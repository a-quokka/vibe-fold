...
2026-09-15, Codex 내장 image generation 도구로 새로 제작했습니다. 기존 썸네일을 화풍 참고로 사용하고, 한지·황토색 박·먹 번짐을 유지했습니다. 흥부의 박에서 흐르는 쌀·비단과 놀부의 박에서 나오는 먹빛 소동을 제비와 넝쿨로 연결한 가로 16:10 구도입니다. 그림 안에는 제목이나 UI를 넣지 않았습니다.

생성 결과 ID: `exec-6226f8e6-a257-48c2-9ca2-9284e236ac27`. 생성 PNG를 1280×800 WebP로 최적화하여 `thumbnail.webp`로 사용합니다. 원본은 Codex 생성 이미지 저장소에 보존하며 사이트는 외부 경로에 의존하지 않습니다.

실제 FolderOpening 썸네일은 16:10이며 목록은 object-fit: cover로 잘라 표시합니다. 이를 확인하여 세로 시안의 두 박을 좌우로 다시 배치하고, 제비·쌀·먹 소동이 가로 카드에 함께 보이도록 생성했습니다.
